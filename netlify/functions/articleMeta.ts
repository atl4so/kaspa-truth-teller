...
export const metaContent: MetaContent = {
  '1': {
    title: 'KaspArchive #1: Fair Launch Facts',
    description: 'Comprehensive analysis debunking myths about Kaspa\'s fair launch, DAGLabs involvement, and early mining activities.',
  },
  '2': {
